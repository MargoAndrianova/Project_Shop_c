 ...
 * shop.h
 *
 * Заголовочний файл, що містить:
 * - Визначення структур даних для магазину, продуктів та працівників.
 * - Прототипи функцій для роботи з продуктами, працівниками, продажами та файлами.
 */
